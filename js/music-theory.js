...
class MajorPentatonicScale extends AbstractScale {
    constructor () {
        super();
        this.intervals = [0, 2, 3, 4, 7, 9];
    }
}

class MinorPentatonicScale extends AbstractScale {
    constructor () {
        super();
        this.intervals = [0, 3, 5, 6, 7, 10];
    }
}
...
class Scales {
    ...
    static get(scaleType, tonalCenter) {
        ...
        case 'major-pentatonic':
            return new MajorPentatonicScale().get(tonalCenter);
        case 'minor-pentatonic':
            return new MinorPentatonicScale().get(tonalCenter);
        default:
